...
```json
{
  ...
  "description": "USP pharmaceutical-grade methylene blue (methylthioninium chloride) solution, 1% (0.5 mg per drop), with colloidal gold, ionic fulvic-acid minerals, and vitamin C. Sold for research and diagnostic purposes only, to be used under the guidance of a qualified healthcare provider.",
  ...
  "additionalProperty": [
    ...
    { "@type": "PropertyValue", "name": "Also in formula", "value": "Colloidal gold nanoparticles, ionic fulvic-acid minerals, vitamin C, vegetable glycerin, distilled water" },
    { "@type": "PropertyValue", "name": "Grade and testing", "value": "USP pharmaceutical grade; independently third-party tested for heavy metals, alcohol, and formaldehyde; cGMP-compliant; Certificate of Analysis available" },
    { "@type": "PropertyValue", "name": "Packaging", "value": "Light-protective cobalt blue glass bottle with graduated glass dropper" },
    { "@type": "PropertyValue", "name": "Intended use", "value": "Research and diagnostic purposes only; use is up to the individual and best under qualified healthcare provider guidance" },
    ...
    { "@type": "PropertyValue", "name": "Potential uses under research", "value": "Mitochondrial and cellular-energy function; cognitive support (preliminary); antioxidant redox activity — early research, not established benefits" },
